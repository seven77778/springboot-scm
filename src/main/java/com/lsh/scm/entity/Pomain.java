...
public class Pomain {
    ...
    public String toString() {
        return "Pomain [poId=" + poId + ", venderCode=" + venderCode + ", account=" + account + ", createTime="
                + createTime + ", tipFee=" + tipFee + ", productTotal=" + productTotal + ", poTotal=" + poTotal
                + ", payType=" + payType + ", prePayFee=" + prePayFee + ", status=" + status + ", remark=" + remark
                + ", stockTime=" + stockTime + ", stockUser=" + stockUser + ", payTime=" + payTime + ", payUser="
                + payUser + ", prePayTime=" + prePayTime + ", prePayUser=" + prePayUser + ", endTime=" + endTime
                + ", endUser=" + endUser + ", venderName=" + venderName + ", poitems=" + poitems + "]";
    }
